...
# Working Directory
WD=/media/sn/Frieder_Data/Projects/White_Matter_Alterations/SN/Results/HCP_Parcellation/PAULI_SN_7T_Parcellation_waypoints
...
WAYPOINT_MASKS=/media/sn/Frieder_Data/Masks/SN_waypoint_masks
