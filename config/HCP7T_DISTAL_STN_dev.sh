...
# List of Subject_IDs
SUB_LIST=/media/sn/Frieder_Data/Projects/White_Matter_Alterations/STN/data/test_subjects.txt

# Working Directory
WD=/media/sn/Frieder_Data/Projects/White_Matter_Alterations/STN/Results/HCP_Parcellation/DEV
...
# 10_group_refer, the switch of matching hemispheres, 1--yes, 0--no
MATCH_HEMI=1
